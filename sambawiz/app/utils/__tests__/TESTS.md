...
**Total Tests:** 213 automated across 13 suites + a legacy manual test plan
...
**File:** [model-selection.test.tsx](model-selection.test.tsx) · **Component:** `ModelSelection` (formerly `BundleForm`) · **Tests:** 22
