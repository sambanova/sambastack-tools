...
**File:** [model-deployment.test.tsx](model-deployment.test.tsx) · **Component:** `ModelDeploymentManager` (formerly `BundleDeploymentManager`) · **Tests:** 23 (6 status logic + 7 probe-failure logic + 10 integration)
...
| model-deployment.test.tsx | 23 | Deployment status logic (6) + probe-failure logic (7) + ModelDeployment integration (10) |
